...
Taken from Tiberius's [buffer overflow cheatsheet]), y notes dded(https://github.com/Tib3rius/Pentest-Cheatsheets/blob/master/exploits/buffer-overflows.rst), my notes added   
